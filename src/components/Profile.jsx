    ...
    return (
        <section id="profile" style={{ overflow: "hidden" }}>
            ...
            <div className="section__pic-container">
                <img className="profile-pic" src="/assets/profile-pic.jpg" alt="Saimon's Profile" data-aos="fade-right" />
            </div>
            <div className="section__text">
                <p className="section__text__p1" data-aos="fade-right">Hello, I'm</p>
                <h1 className="title" data-aos="fade-left">Saimon</h1>
                <p className="section__text__p2" data-aos="fade-right">Frontend Developer</p>
